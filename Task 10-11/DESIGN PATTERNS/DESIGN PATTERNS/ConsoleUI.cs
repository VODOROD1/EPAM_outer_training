...
{
    //Исправлено следующим образом: сделал взаимодействие PL и BLL более в рамках трехслойки, а именно -- 
    //-- перенес класс проверки введенных данных из уровня PL в уровень BLL
    class ConsoleUI : IUI
    {
